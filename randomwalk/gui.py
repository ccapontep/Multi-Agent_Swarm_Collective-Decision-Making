...
class CRWLEVYgui(pysage.PysageGUI):
    ...
    def initialize(self):
        ...
        for i in range(self.arena.num_targets):
            ...
            self.targets_id.append(self.w.create_oval((xpos-target_halfsize,ypos-target_halfsize,xpos+target_halfsize,ypos+target_halfsize), fill= t.color, tags=(target_tag)))
